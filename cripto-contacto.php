        ...
        <div class="row row-fluid clearfix mbf">
            ...
            <div class="span4 sidebar">
                <div class="def-block widget">
                    <h4> Donde estamos </h4><span class="liner"></span>
                    <div class="widget-content">
                        <div id="map" class="mb"></div>
                        <div class ="logoseack" title="seasick management & sound">
                            <img src="images/player/seasicklogo.jpg" alt="seasick management & sound">
                        </div>
                        ...
                        <p>Teléfono: <strong> (+34) 674 972 798 Miguel </strong> <br>
                           Teléfono: <strong> (+34) 608 578 754 Diego </strong> <br>
                            ...
                            Email: <strong><a href="mailto:seasickmanagement@gmail.com">seasickmanagement@gmail.com</a></strong>
