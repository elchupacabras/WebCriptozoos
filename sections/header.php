...
<head>
	...
	<!-- Seo Meta -->
		<meta name="description" content="Los Criptozoos - Music & Band Site Template HTML5 and CSS3">
	...
	<!-- Favicon -->
		<link rel="shortcut icon" href="images/soy-pirata.png">
				...
				<div class="def-block widget">
					...
					<div class="widget-content row-fluid">
						<form id="popup_login_form">
							...
							<a href="index.html#" class="tbutton small"><span>Sign In</span></a>
							<a href="index.html#" class="tbutton color2 small"><span>Register</span></a>
						</form><!-- login form -->
					</div><!-- content -->
				</div><!-- widget -->
						...
						<ul class="sf-menu">
							<li class="current selectedLava"><a href="index.html">Home<span class="sub">start here</span></a>
								...
								<!--	<li><a href="index_modern.html">Home 3 - Modern</a></li> -->
									<li><a href="index.html">Home with Footer</a></li>
								...
								<ul>
									<li><a href="index.html#">Shortcodes</a>
										<ul>
											...
											<li><a href="index.html#">Typography</a>
												<ul>
									...
									<li><a href="index.html#"><i class="icon-caret-right mi"></i>3rd Level</a>
										<ul>
											<li><a href="index.html#">1st Menu</a></li>
											<li><a href="index.html#">2nd Menu</a></li>
											<li><a href="index.html#">Another Sub</a>
												<ul>
													<li><a href="index.html#">1st Menu</a></li>
													<li><a href="index.html#">2nd Menu</a></li>
												</ul>
							...
							<li><a href="index.html#">Pages<span class="sub">more templates</span></a>
								<ul>
