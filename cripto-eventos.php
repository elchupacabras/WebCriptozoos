            ...
            <nav>
                <ul class="sf-menu">
                    ...
                    <li><a href="cripto-musica.php">Material<span class="sub">Contenido digital</span></a>
                        <ul>
                            <li><a href="cripto-fotos.php">Galería de fotos</a></li>
                            <li><a href="cripto-videos.php">Vídeos</a></li>
                            <li><a href="cripto-musica.php">Música</a></li>
                        </ul>

                    </li>
                    <li><a href="cripto-eventos.php">Eventos<span class="sub">Próximos eventos</span></a></li>
                    <li><a href="cripto-contacto.php">Contacto<span class="sub">Contacta con nosotros</span></a>
                </ul><!-- end menu -->
            </nav><!-- end nav -->
        </div><!-- row -->
    </div><!-- headdown -->
            ...
            <ul>
                ...
                <li data-transition="random" data-slotamount="7" data-masterspeed="300" >
                    ...
                    <div class="tp-caption big_black randomrotate"
                         ...
                         data-speed="500"
                         data-start="1200"
                         data-easing="easeInOutExpo"  >Nuevo disco</div>
                    ...
                    <div class="tp-caption big_orange randomrotate"
                         ...
                         data-speed="500"
                         data-start="1700"
                         data-easing="easeInOutExpo"  >Próximamente...</div>
                </li>
                ...
                <li data-transition="random" data-slotamount="7" data-masterspeed="300" >
                    ...
                    <div class="tp-caption large_text randomrotate"
                         ...
                         data-speed="500"
                         data-start="1000"
                         data-easing="easeInOutExpo"  >Integrantes de la banda</div>
                    ...
                    <div class="tp-caption medium_text randomrotate"
                         ...
                         data-speed="500"
                         data-start="1500"
                         data-easing="easeInOutExpo"  >Salva </div>
                    ...
                    <div class="tp-caption medium_text randomrotate"
                         ...
                         data-speed="500"
                         data-start="2000"
                         data-easing="easeInOutExpo"  >Josué </div>
                    ...
                    <div class="tp-caption medium_text randomrotate"
                         ...
                         data-speed="500"
                         data-start="2500"
                         data-easing="easeInOutExpo"  >Natxo </div>
                    ...
                    <div class="tp-caption medium_text randomrotate"
                         ...
                         data-speed="500"
                         data-start="3000"
                         data-easing="easeInOutExpo"  >Banny </div>
                    ...
                    <div class="tp-caption medium_text randomrotate"
                         ...
                         data-speed="500"
                         data-start="3500"
                         data-easing="easeInOutExpo"  >Rober </div>
        ...
        <div class="row clearfix">
            ...
            <div class="foot-menu">
                <ul>
                    ...
                    <li><a href="cripto-fotos.php">Material</a></li>
