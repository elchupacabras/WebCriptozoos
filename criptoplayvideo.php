...
<head>
    ...
    <!-- Seo Meta -->
    <meta name="description" content="Video Single Wide | Band">
...
<footer id="footer">
    <div class="footer-last">
        <div class="row clearfix">
            <span class="copyright">© 2014 by <a href="#">loscriptozoos.com</a>. All Rights Reserved. Powered by <a href="#">Loscriptozoos.com</a>.</span>
...
<!-- end layout -->
<!-- Scripts <script id="disqus-forumData" type="text/json"><script id="disqus-forumData" type="text/json">-->
